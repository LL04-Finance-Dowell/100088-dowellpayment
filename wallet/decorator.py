    ...
    def wrapper(request, *args, **kwargs):
        try:
            ...
            try:
                ...
                return view_func(request, username=username, email=email,sessionID=sessionID,*args, **kwargs)
            except:
            ...
            if session_id is None:
                ...
                # Call the original view function with the username and email
                return view_func(request, username=username, email=email, sessionID=session_id, *args, **kwargs)
    return wrapper