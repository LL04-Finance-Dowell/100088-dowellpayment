...
def CreateDowellTransaction(
    ...
    get_count_resp = json.loads(
        requests.post(url, json=get_count_data, headers=headers).json()
    )
    ...
    if get_count_resp["data"] == None:
        ...
        create_count_data = {
            ...
            "function_ID": "ABCDE",
            "command": "insert",
            "field": {"count": "count", "value": 1},
            "update_field": {},
            "platform": "bangalore",
        }
        create_count_resp = json.loads(
            requests.post(url, json=create_count_data, headers=headers).json()
        )
        ref_number = 1
    ...
    if get_count_resp["data"] != None:
        ...
        data = {
            ...
            "update_field": {"value": new_value},
            "platform": "bangalore",
        }
        update_count_resp = json.loads(
